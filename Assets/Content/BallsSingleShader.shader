...
Shader "MEL/Volumetric/Balls Single Shader" {
	...
	// uniform values
		...
		// arrays
			...
			uniform half4 _Neighbor1;
			uniform half4 _Neighbor2;
			uniform half4 _Neighbor3;
			uniform half4 _Neighbor4;
			uniform half4 _Neighbor5;
			uniform half4 _Neighbor6;
